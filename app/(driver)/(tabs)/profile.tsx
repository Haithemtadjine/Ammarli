...
const styles = StyleSheet.create({
  ...
  header: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 15, height: 60, borderBottomWidth: 1, borderBottomColor: COLORS.border },
  ...
  verifiedBadge: { position: 'absolute', bottom: 2, left: 2, backgroundColor: COLORS.secondary, borderRadius: 12, padding: 3, borderWidth: 2, borderColor: COLORS.white },
  userName: { fontSize: 28, fontFamily: 'Cairo-Black', color: COLORS.primary, marginBottom: 5 },
  ratingRow: { flexDirection: 'row-reverse', alignItems: 'center', marginBottom: 5 },
  ...
  sectionTitle: { fontSize: 16, fontFamily: 'Cairo-Black', color: COLORS.primary, textAlign: 'right', marginBottom: 15 },
  menuItem: { flexDirection: 'row-reverse', alignItems: 'center', backgroundColor: COLORS.white, padding: 15, borderRadius: 20, marginBottom: 10, elevation: 2, shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 10 },
  ...
  logoutButton: { flexDirection: 'row-reverse', alignItems: 'center', marginHorizontal: 20, marginTop: 15, backgroundColor: COLORS.dangerBg, padding: 15, borderRadius: 20 },
  ...
  logoutText: { fontSize: 17, fontFamily: 'Cairo-Black', color: COLORS.danger, flex: 1, textAlign: 'right' },
});
