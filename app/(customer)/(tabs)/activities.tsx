...
const styles = StyleSheet.create({
  ...
  tabContainer: { flexDirection: 'row', borderBottomWidth: 1, borderBottomColor: '#E5E5EA', marginHorizontal: 25 },
  ...
  cardMainRow: { flexDirection: 'row', justifyContent: 'flex-end', marginBottom: 20 },
  orderInfo: { flex: 1, marginRight: 20, alignItems: 'flex-end' },
  orderTitle: { fontSize: 14, color: THEME_NAVY, fontFamily: 'Cairo-SemiBold', textAlign: 'right', lineHeight: 22 },
  ...
  cardActions: { flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', borderTopWidth: 1, borderTopColor: '#F2F2F7', paddingTop: 15 },
  ...
  detailRow: { flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#F2F2F7' },
  detailLabel: { fontSize: 15, fontFamily: 'Cairo-Regular', color: '#8E8E93', marginLeft: 15, width: 100, textAlign: 'right' },
  detailValue: { flex: 1, fontSize: 15, fontFamily: 'Cairo-SemiBold', color: THEME_NAVY, textAlign: 'right' },
  ...
  fullCallBtn: { flexDirection: 'row', backgroundColor: THEME_GOLD, paddingHorizontal: 25, paddingVertical: 12, borderRadius: 30, alignItems: 'center' },
